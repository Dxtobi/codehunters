...
export default function Comment(params: { data: any; }) {
   ...
   // const router = useRouter();
    ...
    return (
        <div className={` break-words  w-full whitespace-normal ${data.accepted? "bg-[#30343a] box-shadow text-[#ffffff]":"bg-[#ffffff] text-[#30343a]"}  mb-3 p-5 rounded-lg flex items-start gap-2`}>
